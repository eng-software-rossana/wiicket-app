...
const PcBuild = () => {
  ...
  const { incrementCost, addCartItem, cartItems } = useContext(
    CartContext,
  ) as ShoppingList;

  const componentsArray: any = Object.values(categoriesData);
      ...
      <Button
        ...
        onPress={() => {
          ...
          if (
            ...
            if (selected !== '') {
              const componentsList: Product[] =
                componentsArray[currentCategory];
